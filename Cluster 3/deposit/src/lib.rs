...
pub struct NewOrder<'info> {
    ...
    /// CHECK: no need to check this.
    pub coin_vault: AccountInfo<'info, TokenAccount>,
    // Also known as the "quote" currency. For a given A/B market,
    // this is the vault for the B mint.
    /// CHECK: no need to check this.
    pub pc_vault: AccountInfo<'info, TokenAccount>,
    /// CHECK: no need to check this.
...
pub struct CancelOrder<'info> {
    ...
    pub event_queue: AccountInfo<'info>,
    /// CHECK: no need to check this.
    pub cancel_market_bids: AccountInfo<'info>,
    /// CHECK: no need to check this.
    pub cancel_market_asks: AccountInfo<'info>,
    // Token account where funds are transferred from for the order. If
    // posting a bid market A/B, then this is the SPL token account for B.
    /// CHECK: no need to check this.
    pub cancel_order_payer_token_account: AccountInfo<'info>,
    /// CHECK: no need to check this.
    pub open_orders_authority: AccountInfo<'info>,
    // Also known as the "base" currency. For a given A/B market,
    // this is the vault for the A mint.
...
pub struct RemoveLimit {
    pub market: AccountInfo<'info>,
    pub remove_orders: AccountInfo<'info>,
    pub request_remove_queue: AccountInfo<'info>,
    pub remove_event_queue: AccountInfo<'info>,
    pub remove_market_bids: AccountInfo<'info>,
    pub remove_market_asks: AccountInfo<'info>,
    pub remove_order_payer_token_account: AccountInfo<'info>,
    pub remove_open_orders_authority: AccountInfo<'info>,
...
pub struct AcceptLimit {
    pub market: AccountInfo<'info>,
    pub accept_orders: AccountInfo<'info>,
    pub accept_request_queue: AccountInfo<'info>,
    pub accepte_event_queue: AccountInfo<'info>,
    pub accept_market_bids: AccountInfo<'info>,
    pub accept_market_asks: AccountInfo<'info>,
    pub accept_order_payer_token_account: AccountInfo<'info>,
    pub accept_open_orders_authority: AccountInfo<'info>,
    pub coin_vault: AccountInfo<'info>,
    pub pc_vault: AccountInfo<'info>,
    pub token_program: AccountInfo<'info>,
    pub rent: AccountInfo<'info>,
...
pub struct ChangeLimit {
    pub market: AccountInfo<'info>,
    pub change_orders: AccountInfo<'info>,
    pub request_change_queue: AccountInfo<'info>,
    pub change_event_queue: AccountInfo<'info>,
    pub change_market_bids: AccountInfo<'info>,
    pub change_market_asks: AccountInfo<'info>,
    pub change_order_payer_token_account: AccountInfo<'info>,
    pub change_open_orders_authority: AccountInfo<'info>,
    pub coin_vault: AccountInfo<'info>,
    pub pc_vault: AccountInfo<'info>,
    pub token_program: AccountInfo<'info>,
    pub rent: AccountInfo<'info>,
